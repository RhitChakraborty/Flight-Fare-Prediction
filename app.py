...
dep_time=st.sidebar.slider('Departure time',datetime.time(5,30),datetime.time(5,29))
dep_hour=int(dep_time.hour)
dep_min=int(dep_time.minute)
#st.write("You're scheduled for:", dep_time)

arr_time=st.sidebar.slider('Arrival time',datetime.time(5,30),datetime.time(5,29))
